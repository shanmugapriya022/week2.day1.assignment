...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Shanmugapriya");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Dharmalingam");
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("PRIYAS");
